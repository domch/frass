...
var _libsRadioRadioMin = require('./_libs/Radio/radio.min');

var _libsRadioRadioMin2 = _interopRequireDefault(_libsRadioRadioMin);
...
var _module = {
    subscribe: function subscribe(pTopic, pObserver) {
        (0, _libsRadioRadioMin2['default'])(pTopic).subscribe(pObserver);
    },

    broadcast: function broadcast(pTopic, pData) {
        if (pTopic[0] === "*") {
            (0, _libsRadioRadioMin2['default'])(pTopic).broadcast(pData);
        } else {
...
},{"./_libs/Radio/radio.min":8,"./repository/ControllerRepository":12}],4:[function(require,module,exports){
'use strict';
...
},{"./EventFactory":3,"./RouteResolver":5,"./Utils":6,"./ViewFactory":7,"./repository/ControllerRepository":12,"./repository/ServiceRepository":13}],5:[function(require,module,exports){
'use strict';
...
var _libsCrossroadsJsDistCrossroadsMin = require('./_libs/crossroads.js/dist/crossroads.min');

var _libsCrossroadsJsDistCrossroadsMin2 = _interopRequireDefault(_libsCrossroadsJsDistCrossroadsMin);
...
window.onhashchange = function () {
    _libsCrossroadsJsDistCrossroadsMin2['default'].parse(location.hash.replace('#', ''));
};

var _module = {

    init: function init() {
        _libsCrossroadsJsDistCrossroadsMin2['default'].routed.add(console.log, console);
        _libsCrossroadsJsDistCrossroadsMin2['default'].addRoute('!', function () {
            location.hash = '';
        });
    },
    ...
    add: function add(pName, pCallback) {
        _libsCrossroadsJsDistCrossroadsMin2['default'].addRoute(pName, pCallback);
    }
};
...
},{"./_libs/crossroads.js/dist/crossroads.min":9}],6:[function(require,module,exports){
'use strict';
...
},{"./repository/ServiceRepository":13,"ractive":1}],8:[function(require,module,exports){
"use strict";
...
})("radio", undefined, function (b, c) {
  function a(d) {
    a.$.channel(d);return a.$;
  }a.$ = { version: "0.2", channelName: "", channels: [], broadcast: function broadcast() {
      var f,
          j = this.channels[this.channelName],
          d = j.length,
          g,
          h,
          e;for (f = 0; f < d; f++) {
        g = j[f];if (typeof g === "object" && g.length) {
          h = g[0];e = g[1] || c;
        }h.apply(e, arguments);
      }return this;
    }, channel: function channel(d) {
      var e = this.channels;if (!e[d]) {
        e[d] = [];
      }this.channelName = d;return this;
      ...
      var f = arguments,
          ...
          h,
          d = [];for (g = 0; g < e; g++) {
        d = f[g];h = typeof d === "function" ? [d] : d;if (typeof h === "object" && h.length) {
          j.push(h);
        }
      }return this;
...
;(function () {
  var a = function a(_a) {
    function e(a, b) {
      if (a.indexOf) return a.indexOf(b);var c = a.length;while (c--) if (a[c] === b) return c;return -1;
    }function f(a, b) {
      var c = e(a, b);c !== -1 && a.splice(c, 1);
    }function g(a, b) {
      ...
      var b;return (a === null || a === "null" ? b = null : a === "true" ? b = !0 : a === "false" ? b = !1 : a === d || a === "undefined" ? b = d : a === "" || isNaN(a) ? b = a : b = parseFloat(a), b);
    }function l(a) {
      var b = a.length,
          c = [];while (b--) c[b] = k(a[b]);return c;
    }function m(a, b) {
      var c = (a || "").replace("?", "").split("&"),
          ...
          h,
          j,
          l;while (h = c[++e]) g = h.indexOf("="), l = h.substring(0, g), j = decodeURIComponent(h.substring(g + 1)), b !== !1 && (j = k(j)), l in f ? i(f[l]) ? f[l].push(j) : f[l] = [f[l], j] : f[l] = j;return f;
    }function n() {
      this.bypassed = new _a.Signal(), this.routed = new _a.Signal(), this._routes = [], this._prevRoutes = [], this._piped = [], this.resetState();
    }function o(b, c, d, e) {
      var f = h(b),
          g = e.patternLexer;this._router = e, this._pattern = b, this._paramsIds = f ? null : g.getParamIds(b), this._optionalParamsIds = f ? null : g.getOptionalParamsIds(b), this._matchRegexp = f ? b : g.compilePattern(b, e.ignoreCase), this.matched = new _a.Signal(), this.switched = new _a.Signal(), c && this.matched.add(c), this._priority = d || 0;
    }var b, c, d;return (c = /t(.+)?/.exec("t")[1] === "", n.prototype = { greedy: !1, greedyEnabled: !0, ignoreCase: !0, ignoreState: !1, shouldTypecast: !1, normalizeFn: null, resetState: function resetState() {
        this._prevRoutes.length = 0, this._prevMatchedRequest = null, this._prevBypassedRequest = null;
      }, create: function create() {
        return new n();
      }, addRoute: function addRoute(a, b, c) {
        var d = new o(a, b, c, this);return (this._sortedInsert(d), d);
      }, removeRoute: function removeRoute(a) {
        f(this._routes, a), a._destroy();
      }, removeAllRoutes: function removeAllRoutes() {
        var a = this.getNumRoutes();while (a--) this._routes[a]._destroy();this._routes.length = 0;
      }, parse: function parse(a, b) {
        a = a || "", b = b || [];if (!this.ignoreState && (a === this._prevMatchedRequest || a === this._prevBypassedRequest)) return;var c = this._getMatchedRoutes(a),
            d = 0,
            e = c.length,
            f;if (e) {
          this._prevMatchedRequest = a, this._notifyPrevRoutes(c, a), this._prevRoutes = c;while (d < e) f = c[d], f.route.matched.dispatch.apply(f.route.matched, b.concat(f.params)), f.isFirst = !d, this.routed.dispatch.apply(this.routed, b.concat([a, f])), d += 1;
        } else this._prevBypassedRequest = a, this.bypassed.dispatch.apply(this.bypassed, b.concat([a]));this._pipeParse(a, b);
      }, _notifyPrevRoutes: function _notifyPrevRoutes(a, b) {
        var c = 0,
            d;while (d = this._prevRoutes[c++]) d.route.switched && this._didSwitch(d.route, a) && d.route.switched.dispatch(b);
      }, _didSwitch: function _didSwitch(a, b) {
        var c,
            d = 0;while (c = b[d++]) if (c.route === a) return !1;return !0;
      }, _pipeParse: function _pipeParse(a, b) {
        var c = 0,
            d;while (d = this._piped[c++]) d.parse(a, b);
      }, getNumRoutes: function getNumRoutes() {
        return this._routes.length;
      }, _sortedInsert: function _sortedInsert(a) {
        var b = this._routes,
            c = b.length;do --c; while (b[c] && a._priority <= b[c]._priority);b.splice(c + 1, 0, a);
      }, _getMatchedRoutes: function _getMatchedRoutes(a) {
        var b = [],
            c = this._routes,
            d = c.length,
            e;while (e = c[--d]) {
          (!b.length || this.greedy || e.greedy) && e.match(a) && b.push({ route: e, params: e._getParamsArray(a) });if (!this.greedyEnabled && b.length) break;
        }return b;
      ...
      } }, b = new n(), b.VERSION = "0.12.2", b.NORM_AS_ARRAY = function (a, b) {
      return [b.vals_];
    }, b.NORM_AS_OBJECT = function (a, b) {
      return [b];
    }, o.prototype = { greedy: !1, rules: void 0, match: function match(a) {
        return (a = a || "", this._matchRegexp.test(a) && this._validateParams(a));
      }, _validateParams: function _validateParams(a) {
        var b = this.rules,
            c = this._getParamsObject(a),
            d;for (d in b) if (d !== "normalize_" && b.hasOwnProperty(d) && !this._isValidParam(a, d, c)) return !1;return !0;
      }, _isValidParam: function _isValidParam(a, b, c) {
        var d = this.rules[b],
            f = c[b],
            g = !1,
            k = b.indexOf("?") === 0;return (f == null && this._optionalParamsIds && e(this._optionalParamsIds, b) !== -1 ? g = !0 : h(d) ? (k && (f = c[b + "_"]), g = d.test(f)) : i(d) ? (k && (f = c[b + "_"]), g = this._isValidArrayRule(d, f)) : j(d) && (g = d(f, a, c)), g);
      }, _isValidArrayRule: function _isValidArrayRule(a, b) {
        if (!this._router.ignoreCase) return e(a, b) !== -1;typeof b == "string" && (b = b.toLowerCase());var c = a.length,
            d,
            f;while (c--) {
          d = a[c], f = typeof d == "string" ? d.toLowerCase() : d;if (f === b) return !0;
        }return !1;
      }, _getParamsObject: function _getParamsObject(a) {
        var b = this._router.shouldTypecast,
            d = this._router.patternLexer.getParamValues(a, this._matchRegexp, b),
            f = {},
            g = d.length,
            h,
            i;while (g--) i = d[g], this._paramsIds && (h = this._paramsIds[g], h.indexOf("?") === 0 && i && (f[h + "_"] = i, i = m(i, b), d[g] = i), c && i === "" && e(this._optionalParamsIds, h) !== -1 && (i = void 0, d[g] = i), f[h] = i), f[g] = i;return (f.request_ = b ? k(a) : a, f.vals_ = d, f);
      }, _getParamsArray: function _getParamsArray(a) {
        var b = this.rules ? this.rules.normalize_ : null,
            c;return (b = b || this._router.normalizeFn, b && j(b) ? c = b(a, this._getParamsObject(a)) : c = this._getParamsObject(a).vals_, c);
      }, interpolate: function interpolate(a) {
        var b = this._router.patternLexer.interpolate(this._pattern, a);if (!this._validateParams(b)) throw new Error("Generated string doesn't validate against `Route.rules`.");return b;
      ...
      function k() {
        var a, b;for (a in e) e.hasOwnProperty(a) && (b = e[a], b.id = "__CR_" + a + "__", b.save = "save" in b ? b.save.replace("{{id}}", b.id) : b.id, b.rRestore = new RegExp(b.id, "g"));
      }function m(a, b) {
        var c = [],
            d;a.lastIndex = 0;while (d = a.exec(b)) c.push(d[1]);return c;
      }function n(a) {
        return m(d, a);
      }function o(a) {
        return m(e.OP.rgx, a);
      }function p(d, e) {
        return (d = d || "", d && (j === f ? d = d.replace(b, "") : j === h && (d = d.replace(c, "")), d = q(d, "rgx", "save"), d = d.replace(a, "\\$&"), d = q(d, "rRestore", "res"), j === f && (d = "\\/?" + d)), j !== g && (d += "\\/?"), new RegExp("^" + d + "$", e ? "i" : ""));
      }function q(a, b, c) {
        var d, f;for (f in e) e.hasOwnProperty(f) && (d = e[f], a = a.replace(d[b], d[c]));return a;
      }function r(a, b, c) {
        var d = b.exec(a);return (d && (d.shift(), c && (d = l(d))), d);
      }function s(a, b) {
        b = b || {};if (typeof a != "string") throw new Error("Route pattern should be a string.");var c = function c(a, _c) {
          var d;_c = _c.substr(0, 1) === "?" ? _c.substr(1) : _c;if (b[_c] != null) {
            if (typeof b[_c] == "object") {
              var e = [],
                  f;for (var g in b[_c]) {
                f = b[_c][g];if (i(f)) for (var h in f) g.slice(-2) == "[]" ? e.push(encodeURI(g.slice(0, -2)) + "[]=" + encodeURI(f[h])) : e.push(encodeURI(g + "=" + f[h]));else e.push(encodeURI(g + "=" + f));
              }d = "?" + e.join("&");
            } else d = String(b[_c]);if (a.indexOf("*") === -1 && d.indexOf("/") !== -1) throw new Error('Invalid value "' + d + '" for segment "' + a + '".');
          } else {
            if (a.indexOf("{") !== -1) throw new Error("The segment " + a + " is required.");d = "";
          }return d;
        };return (e.OS.trail || (e.OS.trail = new RegExp("(?:" + e.OS.id + ")+$")), a.replace(e.OS.rgx, e.OS.save).replace(d, c).replace(e.OS.trail, "").replace(e.OS.rRestore, "/"));
      }var a = /[\\.+*?\^$\[\](){}\/'#]/g,
          b = /^\/|\/$/g,
          c = /\/$/g,
          d = /(?:\{|:)([^}:]+)(?:\}|:)/g,
          e = { OS: { rgx: /([:}]|\w(?=\/))\/?(:|(?:\{\?))/g, save: "$1{{id}}$2", res: "\\/?" }, RS: { rgx: /([:}])\/?(\{)/g, save: "$1{{id}}$2", res: "\\/" }, RQ: { rgx: /\{\?([^}]+)\}/g, res: "\\?([^#]+)" }, OQ: { rgx: /:\?([^:]+):/g, res: "(?:\\?([^#]*))?" }, OR: { rgx: /:([^:]+)\*:/g, res: "(.*)?" }, RR: { rgx: /\{([^}]+)\*\}/g, res: "(.+)" }, RP: { rgx: /\{([^}]+)\}/g, res: "([^\\/?]+)" }, OP: { rgx: /:([^:]+):/g, res: "([^\\/?]+)?/?" } },
          f = 1,
          g = 2,
          h = 3,
          j = f;return (k(), { strict: function strict() {
          j = g;
        }, loose: function loose() {
          j = f;
        }, legacy: function legacy() {
          j = h;
        }, getParamIds: n, getOptionalParamsIds: o, getParamValues: r, compilePattern: p, interpolate: s });
    })(), b);
  };typeof define == "function" && define.amd ? define(["signals"], a) : typeof module != "undefined" && module.exports ? module.exports = a(require("signals")) : window.crossroads = a(window.signals);
})();

},{"signals":2}],10:[function(require,module,exports){
...
var _libsJqueryDistJqueryMin = require('../_libs/jquery/dist/jquery.min');

var _libsJqueryDistJqueryMin2 = _interopRequireDefault(_libsJqueryDistJqueryMin);

var _module = {
    selector: function selector(_selector) {
        return (0, _libsJqueryDistJqueryMin2['default'])(_selector);
    },
    ...
    attachEvent: function attachEvent(pContainer, pEvent, pCallback) {
        (0, _libsJqueryDistJqueryMin2['default'])(pContainer).on(pEvent, pCallback);
    },
    addModifier: function addModifier(pContainer, pClass) {
        (0, _libsJqueryDistJqueryMin2['default'])(pContainer).addClass(pClass);
    },
    removeModifier: function removeModifier(pContainer, pClass) {
        (0, _libsJqueryDistJqueryMin2['default'])(pContainer).removeClass(pClass);
    }
};
...
},{"../_libs/jquery/dist/jquery.min":10}],15:[function(require,module,exports){
'use strict';
...
var _libsMomentMinMomentWithLocalesMin = require('../_libs/moment/min/moment-with-locales.min');

var _libsMomentMinMomentWithLocalesMin2 = _interopRequireDefault(_libsMomentMinMomentWithLocalesMin);
...
var _module = {
    ...
    appendFile: function appendFile(pLangFile) {
        ...
        _module.langFile = this.files.reduce(function (pCumulator, pCurrent) {
    ...
    formatDate: function formatDate(pDate, pOptions) {
        if ((0, _libsMomentMinMomentWithLocalesMin2['default'])(pDate).isValid()) {
            return (0, _libsMomentMinMomentWithLocalesMin2['default'])(pDate).format("DD-MM-YYYY");
        } else return pDate;
    },
    /*
...
},{"../Utils":6,"../_libs/moment/min/moment-with-locales.min":11}],16:[function(require,module,exports){
'use strict';
...
var _module = {
    call: function call(pAction, pMethod, pHeaders, pData) {
        return _libsJqueryDistJqueryMin2['default'].ajax({
            url: pAction,
            type: pMethod,
            cache: false,
            dataType: 'json',
...
},{"../_libs/jquery/dist/jquery.min":10}],17:[function(require,module,exports){
"use strict";
